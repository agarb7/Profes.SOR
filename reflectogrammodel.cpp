...
QVariant ReflectogramModel::data(const QModelIndex &index, int role) const
{
    ...
    const Reflectogram &r = row.reflectogram;
...
bool ReflectogramModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    ...
    Reflectogram &r = row.reflectogram;
    ...
    case SupplierNameColumn: {
        ...
        String newSupplierName = value.toString().toStdString(); //todo isolate String from std::string by templ spec convert<QString>(String);
    ...
    case OtdrNameColumn: {
        ...
        String newOtdrName = value.toString().toStdString();
    ...
    case OtdrSerialNumberColumn: {
        ...
        String newOtdrSerialNumber = value.toString().toStdString();
    ...
    case ModuleNameColumn: {
        ...
        String newModuleName = value.toString().toStdString();
    ...
    case ModuleSerialNumberColumn: {
        ...
        String newModuleSerialNumber = value.toString().toStdString();
    ...
    case SoftwareVersionColumn: {
        ...
        String newSoftwareVersion = value.toString().toStdString();
    ...
    case SupplierOtherColumn: {
        ...
        String newSupplierOther = value.toString().toStdString();
    ...
    case DateTimeColumn: {
        ...
        LittleUInt32 newDateTime = value.toDateTime().toTime_t();
    ...
    case WavelengthColumn: {
        ...
        LittleUInt16 newWavelength = value.toDouble()*10;
    ...
    case PulseWidthColumn: {
        ...
        LittleUInt16 newPulseWidth = value.toInt();
    ...
    case SampleSpacingColumn: {
        ...
        LittleUInt32 newSampleSpacing = value.toDouble()*100;
    ...
    case IndexOfRefractionColumn: {
        ...
        LittleUInt32 newIndexOfRefraction = value.toDouble()*100000;
    ...
    case BackscatteringCoefficientColumn: {
        ...
        LittleUInt16 newBackscatteringCoefficient = value.toInt();
    ...
    case FiberStartPositionColumn: {
        ...
        LittleInt32 newFiberStartPosition = value.toDouble()*10;
    ...
    case PointsColumn: {
        if (r.empty() || !value.canConvert<LittleUInt16Vector>())
            return false;

        LittleUInt16Vector newPoints = value.value<LittleUInt16Vector>();
...
bool ReflectogramModel::saveFile(int row)
{
    ...
    Reflectogram &rg = r.reflectogram;
